...
def main(argv=None):
    ...
    _, valid_dataset_iter = dataset_manager.gen_train_and_valid(
    ...
    for i, dataset in enumerate(valid_dataset_iter):
        print("Validating {}/{}".format(i+1, len(valid_dataset_iter)))
